		...
		<main className="wrapper">
			<div className="section mb-3 flex flex-col lg:flex-row justify-between align-start gap-5">
				<div className="flex-1">
					...
					<h1 className="uppercase dar">{information.name}</h1>
					<ul className="list-none ps-0">
						...
						<li>
							<Link
								...
								download={true}
							>
								<Paperclip className="inline mr-1 align-top" /> CV
							</Link>
						</li>
					</ul>

					<div className="bg-slate-100 dark:bg-slate-900 dark:text-white rounded-md p-3 my-5 cursor-pointer transition-all">
						{information.bio}
					</div>
				</div>
			...
			<div className="section mb-3">
				...
				<div className="mt-3 space-y-5">
					<div className="mb-5">
						...
						<div className="mb-3 text-gray-600 dark:text-slate-100">6/2025 - now</div>
						<ul className="list-disc list-inside text-gray-700 dark:text-slate-100 ms-4">
					...
					<div className="mb-5">
						...
						<div className="mb-3 text-gray-600 dark:text-slate-100">
							11/2022 - 5/2024
						</div>
						<ul className="list-disc list-inside text-gray-700 dark:text-slate-100 ms-4">
							<li>
			...
			<div className="section mb-3">
				...
				<div className="mt-3 space-y-3">
					<div>
						<h3 className="font-semibold text-base text-gray-800 dark:text-slate-100">
			...
			<div className="section mb-3">
				...
				<ul className="list-disc list-inside text-gray-700 dark:text-slate-100 ms-4 mt-3">
